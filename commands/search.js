...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (Searched.loadType == "NO_MATCHES")
      ...
      SongAddedEmbed.setAuthor(`已添加到歌單`, client.botconfig.IconURL);
      ...
      SongAddedEmbed.addField("作者", `${Song.author}`, true);
      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        switch (Searched.loadType) {
          ...
          case "TRACK_LOADED":
            ...
            return client.sendTime(
              interaction,
              `**已添加到歌單:** \`[${Searched.tracks[0].info.title}](${Searched.tracks[0].info.uri}}\`.`
            );
        ...
        switch (res.loadType) {
          ...
          case "TRACK_LOADED":
            ...
            return client.sendTime(
              interaction,
              `**已添加到歌單:** \`[${res.tracks[0].title}](${res.tracks[0].uri})\`.`
            );
          case "PLAYLIST_LOADED":
